...
class CreateReferenciaConsideraPertinenteGobiernoPromuevaInvestigacionEspacialsTable extends Migration
{
    ...
    public function up()
    {
        ...
        \DB::query("ALTER TABLE referencia_considera_pertinente_gobierno_promueva_investigacion_espacials COMMENT = 'Pregunta #19. Tabla de referencia con las opciones precargadas'");
    }
