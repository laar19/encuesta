...
class CreateReferenciaSiExistieraMasInversionEspacialHabriaAvancesTable extends Migration
{
    ...
    public function up()
    {
        ...
        \DB::query("ALTER TABLE referencia_si_existiera_mas_inversion_espacial_habria_avances COMMENT = 'Pregunta #21. Tabla de referencia con las opciones precargadas'");
    }
