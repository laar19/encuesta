...
<html>
    ...
    <body>
        <div class="wrapper">
            ...
            <!-- form id="register_form" method="post" action="{ { route('registro') } }" onSubmit="event.preventDefault(); validate_ci('cedula1', 'cedula2');" -->
                ...
                <section>
                    <div class="inner" id="fondo">
                        ...
                        <div class="form-content" >
                            ...
                            <div class="form-row">
                                <div class="form-holder">
                                    <input type="text" placeholder="Número de cédula" class="form-control" value="{{ $cedula }}" disabled >
                            ...
                            <div class="checkbox-circle">
                                <div class="col-12">
                                    <button class="btn btn-primary" id="submit" type="submit">Continuar</button>
                                </div>
                            </div>
                        </div>
                    </div>
